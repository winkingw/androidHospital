...
public class AppointmentDao {
    ...
    public Appointment queryAppointmentDetail(long appointmentId) {
        Cursor cursor = null;
        try {
            cursor = db.rawQuery("SELECT a.*, rs.slot_start_time, rs.slot_end_time, rs.register_fee, "
                            + "rs.schedule_id, ds.doctor_id, ds.schedule_date, ds.period, ds.clinic_room, "
                            + "d.doctor_name, d.title, d.department_id, "
                            + "dep.dept_name "
