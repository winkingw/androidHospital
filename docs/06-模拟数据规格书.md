...
> 缴费金额说明：挂号费默认 20.00 元（见 t_register_source.register_fee），实际模拟数据中不同科室/医生可设不同金额（15.00 / 25.00），由 MockDataUtil 插入号源时覆盖默认值。
...
{1,        "张三",      "320102********1234", "3201123456789012",   "13800001111",  8053.30, "2026-01-01","2027-01-01","BOUND"},
{2,        "李四",      "320102********2345", "3201098765432109",   "13800002222",  12039.50,"2026-03-15","2027-03-15","BOUND"},
```
